            ...
            while (true) {
                if (EX_MA_Latch.getFlag() == 1) {
                    ...
                    break;
                            ...
                            || CheckConflict(forwardInstruction, EX_MA_Latch.instruction)
                            || CheckConflict(forwardInstruction, MA_RW_Latch.instruction))
                            && forwardInstruction.getOperationType() != OperationType.nop) {
